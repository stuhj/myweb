         ...
         '   <time class="time">#{created_date}</time>',
          ...
          '  </a>',
           ' <div class="profile-info">',
            '    <a title="#{username}" href="/profile/#{id}">#{username}</a>',
            '</div>',
       ' </header>',
        '<div class="mod-bd">',
         '   <div class="img-box">',
       ...
       '         </li>',
          '      <li>',
           '         <a class=" icon-remove" title="删除评论"></a>',
            '        <a class="_4zhc5 _iqaka" title="#{username0}" href="/profile/#{user_id}" data-reactid=".0.1.0.0.0.2.1.2:$comment-17856951190001917.1">#{username0}</a>',
             '       <span>',
              '          <span>欢迎留言~~~</span>',
               '     </span>',
                '</li>',
